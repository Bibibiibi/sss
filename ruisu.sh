...
#bin下载地址
BIN=http://soft.91yun.org/soft/serverspeeder/bin/CentOS/6.5/2.6.32-504.el6.x86_64/x64/3.10.61.0/serverspeeder_2705
...
rv=CentOS_6.5_2.6.32-504.el6.x86_64
...
echo "开始下载bin运行文件。。。。"
echo "======================================"
curl $BIN -o 91yunserverspeeder/apxfiles/bin/acce-3.10.61.0-[CentOS_6.5_2.6.32-504.el6.x86_64] || { echo "下载bin运行文件失败，请检查";exit 1; }
